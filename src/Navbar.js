        ...
        return (
            <div className="Navbar">
                ...
                <div style={{marginBottom: "1vh", marginTop: "2.5vh"}}>
                    <a href="https://www.linkedin.com/in/devkyleconlon/" target="_blank">
                        <button class="ui circular linkedin icon button">
                            <i class="fab fa-linkedin-in"></i>
                        </button>
                    </a>
                    <a href="https://github.com/KConlon13" target="_blank">
                        <button class="ui circular github icon button">
                            <i class="fab fa-github"></i>
                        </button>
                    </a>
                    <a href="https://medium.com/@kyleconlon13" target="_blank">
                ...
                <Link to="/contact" style={navStyle} > 
                    { this.state.contactClicked === true ? 
                        <div style={{margin: "auto", marginBottom: "1.6vh", color: "black"}} onClick={()=>this.contactClickHandler()}>
                        ...
                        <div style={{margin: "auto", marginBottom: "1.6vh"}} onClick={()=>this.contactClickHandler()}>
                        <i class="fas fa-envelope-open-text" style={{display: "inline", marginRight: "9px"}}></i>
